...
mGold has lower photoncount and step-ratio than mEGFP. This can be the result of the experimental setup and the excitation laser wavelength (we used single 488 nm laser to excite both mEGFP and mGold). That is why we observe mGold region (denoted by red) at the extreme lower left corner.
